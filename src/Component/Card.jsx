...
const Card = ({data}) => {
  ...
  return (
    ...
    <div className="px-6 py-4">
      ...
      <p className="text-gray-400 font-bold">Price:{data.price}</p>
       <p className="text-gray-300 mb-1">Author: {data.auther}</p>
      <p className="text-gray-300 font-bold mb-2">Genre: {data.genre}</p>
    </div>
    <div className="absolute inset-0 bg-black bg-opacity-50 opacity-1 group-hover:opacity-75 group-active:opacity-75 transition-opacity duration-300 flex flex-col justify-center items-center p-4">
      ...
      <p className="text-gray-300 mb-4">Genre: {data.genre}</p>
