...
const Navbar = () => {
  ...
  const handleClick=(e)=>{
    e.preventDefault();
    setparameter(e.target.textContent)
  }
  ...
  return (
    ...
    <nav className="flex items-center justify-between p-4">
      ...
      <ul className="hidden md:flex gap-6 text-lg">
        ...
        <Link to="/all-book/?book"> <li className="hover:text-gray-400 cursor-pointer flex items-center"><FaBook className="mr-2" />Manga</li> </Link>
        <Link to="/category/?category=book" ><li   className="hover:text-gray-400 cursor-pointer flex items-center"><FaQuoteRight className="mr-2" />Quotes</li></Link>
